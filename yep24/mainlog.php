...
<body>
	...
	<div class="container" style="margin-top: 50px;">
		...
		<br><br>
        <div class="row text-center bordify">
                        <h3>No. of People present: </h3>
                        <h1><strong> <?php echo $count?></strong></h1>
                        <br>
